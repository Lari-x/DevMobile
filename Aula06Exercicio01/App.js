...
import logo from './assets/NativeLogo.png'; // Importa a imagem do logo
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.view}>
        ...
        {/* Exibe a imagem com largura dinâmica */}
        <Image source={logo} style={[styles.image, { width: imageWidth }]} />
...
// Foi comentado as partes do Slider, pois ele não funciona
