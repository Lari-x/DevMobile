...
export default function WhereAmI() {
  ...
  useEffect(() => {
    ...
    function setPosition({
      coords: { latitude, longitude }, // Desestrutura as coordenadas latitude e longitude
    }) {
    ...
    (async () => {
      ...
      watcher = await Location.watchPositionAsync(
        {
          accuracy: Location.LocationAccuracy.Highest, // Define a maior precisão possível
        },
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.text}>Endereço atual:</Text>
